...
import ServiceContactCard from "../../components/services/ServiceContactCard";
  ...
  return (
    <div className="bg-lightgray">
      ...
      <header className="px-20 pt-28 ">
        {/* replace with image */}
        <div className="bg-[#bb0d1e2f] relative py-20 px-36">
          <div className="flex items-center justify-between">
            <div className="w-1/2">
              <h1 className="text-5xl pb-10">ESTATES</h1>
          ...
          <div className="bg-darkred px-20 pt-28 pb-10 w-[45vw] absolute top-[90%] right-32 text-white">
            ...
            <ul className="flex justify-between items-center py-20">
              <li className="">
                <Link
                  href="/home#services"
                  className="py-2 px-10 border-2 border-white bg-white bg-fixed text-lightred hover:bg-transparent hover:text-[#ffebee]"
                >
                  Common Questions
                </Link>
              </li>
