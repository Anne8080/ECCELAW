      ...
      {displayBlock && (
        ...
        >
          <li className="py-1 text-base hover:text-linkhover">
            <Link href="/common-questions/faq-business">FAQ - Business</Link>
          </li>
          <li className="py-1 text-base hover:text-linkhover">
            <Link href="/common-questions/faq-estates">FAQ - Estates</Link>
          </li>
          <li className="py-1 text-base hover:text-linkhover">
            <Link href="/common-questions/faq-ai-governance">FAQ - AI Governance</Link>
          </li>
        </ul>
      )}
    </li>
